...
export default function ScenesPage() {
  ...
  // Helper functions for editor - using shared utilities
  const supportsCct = (fixture: FixtureWithModel): boolean => checkSupportsCct(fixture.model?.type);
  const isDimmable = (fixture: FixtureWithModel): boolean => checkIsDimmable(fixture.model?.type);
