...
See the `/ws` endpoint documentation for subscription management.
        ...
        openapi_tags=[
            ...
            {
                "name": "dtw",
                "description": "Dim-to-warm configuration. Automatic CCT adjustment based on brightness for natural dimming behavior.",
            },
        ],
    )
...
Use this endpoint to monitor system performance and debug issues.
    ...
    from tau.api.routes import fixtures, groups, scenes, control, circadian, labjack, discovery, switches, system_config, updates, software_updates, dtw, gpio
    ...
    app.include_router(gpio.router, prefix="/api/gpio", tags=["hardware"])
    ...
    app.include_router(dtw.router, prefix="/api/dtw", tags=["dtw"])
